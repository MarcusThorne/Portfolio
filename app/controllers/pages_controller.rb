class PagesController < ApplicationController
  def home
    ...
    @projectCategories = [ "React", "Styled Components", "Rails", "Tailwind", "JavaScript", "PostgreSQL", "SQL", "Slick Carousel", "Parallax", "Stripe", "CSS", "SCSS" ]
    ...
    @websites = [
      {
        ...
        github: true,
        website: 'https://unwind-yoga.herokuapp.com/'
      },
      {
        title: 'Ilfracombe 54',
        ...
        github: false,
        website: 'https://ilfracombe54.co.uk'
      },
      {
        ...
        github: true,
        website: 'https://modest-lamarr-215700.netlify.app/'
      },
      {
        ...
        github: true,
        website: 'https://the-vase-library.herokuapp.com/'
      },
      {
        ...
        github: true,
        website: 'https://quote-calculator.vercel.app/'
      },
    ]
